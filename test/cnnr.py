...
from layers.DropoutHiddenLayer import DropoutHiddenLayer
...
class CNNRNet(object):
    def __init__(self,
        ...
        Fl0Drop= DropoutHiddenLayer(self, rng, input=Flayer0.output, n_in=Fl0out, n_out=Fl0out,p=0.5, is_train=0)
